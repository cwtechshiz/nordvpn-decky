...
# Define paths
PLUGIN_DIR="/home/deck/homebrew/plugins/nordvpn-decky"
...
echo "Extracting files to Decky environment..."
# Clean up any old version first
mkdir -p "$PLUGIN_DIR"
rm -rf "$PLUGIN_DIR"/*

# Unzip straight into the plugins folder
unzip -q /tmp/nordvpn-decky-install/plugin.zip -d /home/deck/homebrew/plugins/
